...
export const PlotAssetIcon = (props: SvgProps) => (
  <Svg
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      d="m10.75 11.966 4.17 2.083a1.3 1.3 0 0 0 1.162 0l4.125-2.061m-6.917-1.354 4.811 2.407m.389 5.393 4.811 2.407M8.09 18.434l4.811 2.407m3.05-1.076 4.169 2.084a1.3 1.3 0 0 0 1.162 0l4.124-2.061M5.55 19.765 9.72 21.85a1.3 1.3 0 0 0 1.162 0l4.124-2.061m.495-5.447v5.2m5.2 2.6v4.55m-10.4-4.55v4.55M24.836 30.167h1.833l5.195-5.195a1.296 1.296 0 1 0-1.834-1.833l-5.194 5.194v1.834"
    />
    <Path
      stroke={props.color ? props.color : '#1B6BC0'}
      strokeLinecap="round"
